...
import { footerLinks } from "@/components/footer/footerConstants";

const Footer = () => {
  return (
    // TODO: fix bg
    <footer className="mt-32 md:mt-52 pb-[60px] pt-[40px] bg-[url('/images/footer/footer-bg.png')] w-full bg-palette-pearl text-palette-gray">
